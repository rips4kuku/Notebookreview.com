...
$sql="SELECT * FROM test.adddeals WHERE company = '".$q."'";
...
while($row = mysqli_fetch_array($result))
  ...
  echo "<td><a href = 'Dell/".$row['picture']."'><img src='Dell/".$row['picture']."' height ='200' width='200'></a></td>";
 // echo '<td><a href = 'Dell/".$row['picture']."'> <img src='Dell/".$row['picture']."' height ="50%" width="50%"/></a></td>';
