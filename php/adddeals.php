...
$sql="INSERT INTO adddeals (company,model,processor,windows,harddisk,ram,price,picture)
...
else
{
	...
	echo "<script type=\"text/javascript\">window.alert('Deal is successfully added.');window.location.href = 'http://harvey.binghamton.edu/~rnaik1/adddeals.html';</script>"; 
   //exit;
}
